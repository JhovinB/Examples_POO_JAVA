	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (op) {
				...
				case 5:
					System.out.println("Introducir edad máxima: ");
					edad=Integer.parseInt(sc.nextLine());
					Contacto[]filtro= gcontactos.recuperarEdadMaxima(edad);
					for (Contacto co : filtro) {
						System.out.println(co.getNombre()+"-"+co.getEmail()+"-"+co.getEdad());
					}
					break;
